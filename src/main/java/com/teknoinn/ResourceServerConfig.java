...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/consultaarticulos/**").permitAll()
		.antMatchers("/compradores/**").permitAll()
 ...
 * .antMatchers("/v2/api-docs/**").permitAll()
		...
		.antMatchers("/consultaarticulos/**").authenticated()
		.antMatchers("/compradores/**").permitAll()
		.antMatchers("/envios/**").authenticated()
		.antMatchers("/menus/**").authenticated()
		.antMatchers("/tokens/**").permitAll()
		.antMatchers("/pagos/**").authenticated()
		.antMatchers("/vendedores/**").authenticated();
 */
